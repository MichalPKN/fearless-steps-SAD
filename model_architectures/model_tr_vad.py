...
class Embedding(nn.Module):
    def __init__(self, dim_in=30, dim_out=128, units_in=9, units_out=18, drop_rate=0.3):
        super().__init__()
...
class VADModel(nn.Module):
    def __init__(self, dim_in=30, d_model=56, units_in=8, units=16, P=16, layers=2, drop_rate=0.3,
                 activation=nn.ReLU()):
        super().__init__()
        self.net = nn.Sequential(
