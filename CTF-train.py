                ...
                for num_layers in [6]:
                    for hidden_size in [128]:
                        for learning_rate in [0.0005]: #[0.001, 0.0001, 0.00001]:
                            ...
                            best_val = 100
                            model_path = os.path.join(datadir_path, "models", f"model_ctf_{batch_size}-{audio_size}_{learning_rate}_{hidden_size}_{num_layers}.pt")
                            ...
                            print(f"input parameters: context_size: {context_size}, input_size: {input_size}")
